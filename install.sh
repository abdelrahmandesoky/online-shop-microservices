...
helm install -f values/productcataloge-service-values.yaml productcatalogeservice charts/microservice
helm install -f values/recommendations-service-values.yaml recommendationservice charts/microservice
